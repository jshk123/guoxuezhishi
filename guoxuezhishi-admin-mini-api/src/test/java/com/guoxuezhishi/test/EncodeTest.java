...
public class EncodeTest {
    public static void main(String[] args) throws UnsupportedEncodingException {
     /*   try {
            EncodeTest convert = new EncodeTest();
...
/*        byte[] fullByte1 = new String("发票推送停车场(修改)".getBytes(), "UTF-8").getBytes("GBK");
        String fullStr = new String(fullByte1, "GBK");
        System.out.println(GetEncoding.getEncoding(fullStr) + fullStr);*/
        String a = new String("氓莽楼篓忙篓茅氓猫陆娄氓潞(盲驴庐忙鹿)".getBytes("GBK"), "ISO-8859-1");
